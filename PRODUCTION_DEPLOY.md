# 驻场运维管理系统 v1.0.14 生产安装部署说明

本文档用于在生产环境部署 `onsite-ops-system-v1.0.14`。
...
GitHub Release：https://github.com/hnhywjw/onsite-ops-system/releases/tag/v1.0.14
...
tar -xzf onsite-ops-system-v1.0.14-production.tar.gz
```
